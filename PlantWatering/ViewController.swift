...
class ViewController: UIViewController {
    ...
    let plants = ["tomatoes", "apple", "sage", "chives"]
...
//    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "goToSecond" {
            ...
            destinationVC.text = descriptionWeather
    ...
    func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        if((pickerView.tag == 2)){
            ...
            case 0:
                ...
                break
            case 3:
                SelectedPlant.text = "\(plants[row]) need to be watered every 3 days."
                updatePlant = 3
                break
            default:
                // statements
...
extension ViewController : WeatherManagerDelegate {
    func didUpdateWeather(weather : WeatherModel) {
        DispatchQueue.main.async {
            ...
            self.longitude = (weather.longitudeCoord)
            self.latitude = weather.latitudeCoord
            self.descriptionWeather = weather.blurb
            print("This is the longitude \(self.longitude)")
            print("This is the latitude \(self.latitude)")
